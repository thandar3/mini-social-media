...
<body class="animsition" style="background-color: whitesmoke">
    <div class="page-wrapper">
        <!-- MENU SIDEBAR-->
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img class="ms-3" src="{{ asset('sociallogos.png') }}" style="height: 100px; width: 150px"
                        alt="Cool Admin" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="{{ route('user#home', Auth::user()->id) }}">
                                <i class="fa-solid fa-house"></i> Home Page
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('user#friendList') }}">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('user#comfirmPassword') }}">
                                                        <i class="zmdi zmdi-account"></i>Edit Password</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    @csrf
                                                    <button class="btn bg-dark text-white col-10"> <i
                                                            class="fa-solid fa-house"></i> Logout</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
